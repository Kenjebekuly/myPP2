...
pygame.display.set_caption("game_players Game")
...
def spawn_food():
    ...
    while True:
        ...
        if candidate not in walls and candidate not in game_players:
            food = candidate
            break
...
def update_game_players():
    """Moves game_players, checks collisions, spawns new food, updates global score/level/walls/speed if needed."""
    global game_over, score, level, speed, walls

    head = game_players[0]
    new_head = (head[0] + direction[0], head[1] + direction[1])

    if new_head in game_players or new_head in walls:
    ...
    game_players.insert(0, new_head)
